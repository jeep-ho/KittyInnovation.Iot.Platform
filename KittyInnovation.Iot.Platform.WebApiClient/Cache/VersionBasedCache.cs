...
namespace KittyInnovation.Iot.Platform.WebApiClient.Cache
{
    /**************************
     Author:hezp
     Time:2017/8/20 9:33:38
     Desc：
    ***************************/
         ...
         where TItem : class
    {
        ...
        {
            TimeSpan slidingExpirationTimeout = System.Web.Caching.Cache.NoSlidingExpiration;
            DateTime expirationTime = System.Web.Caching.Cache.NoAbsoluteExpiration;
